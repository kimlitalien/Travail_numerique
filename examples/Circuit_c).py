...
if __name__ == "__main__":
    ...
    # on calcule le nombre de points proportionnel à l'angle
  ...
  #section de droite(bas)
    ...
    ground_position = (paramétrisation_cercle(rayon, -11/24 * np.pi, -13/24 * np.pi, points)[0][0], paramétrisation_cercle(rayon, -11/24 * np.pi, -13/24 * np.pi, points)[1][0])
